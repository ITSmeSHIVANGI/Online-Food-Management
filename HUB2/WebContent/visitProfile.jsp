...
body{
width:100%;
background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url("images/jennie-brown.jpg") center fixed no-repeat;
...
.card.hovercard .cardheader {
    background: url("images/visitfood.jpg");
    background-size: cover;
    height: 165px;
}
...
try {
    ...
    String sql="Select distinct c.FirstName,c.LastName,c.Mobile,c.Address,c.City,c.State from customerdetails c,orders o where c.email=o.email";
	...
	<div class="row">
		<div class="col-lg-3 col-sm-6">
            ...
            <div class="card hovercard">
                ...
                <div class="info">
                    <div class="title">
                        <a href="#" style="color:brown"><%=FirstName %><%=LastName %></a>
                    </div>
                ...
                <div class="bottom">
                    ...
                    <a class="btn btn-danger btn-sm" rel="publisher"
                       href="https://plus.google.com/+ahmshahnuralam">
                        <i class="fa fa-google-plus" style="margin-top:5px;"></i>
                    </a>
                    ...
                    <a class="btn btn-warning btn-sm" rel="publisher" href="https://plus.google.com/shahnuralam">
                        <i class="fa fa-behance" style="margin-top:5px;"></i>
                    </a>
                </div>
            </div>
